const scaleNames = {
  ...
  class TemperatureInput extends React.Component {
    ...
    render() {
      ...
      return React.createElement("fieldset", null, React.createElement("legend", null, "Enter temperature in ", scaleNames[scale], ":"), React.createElement("input", {
        value: temperature,
  ...
  ReactDOM.render(React.createElement(Calculator, null), document.getElementById('text_box'));